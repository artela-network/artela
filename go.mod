...
require (
	...
	github.com/artela-network/artela-evm v0.4.6-beta
	github.com/artela-network/aspect-core v0.4.6-beta
...
replace (
	...
	//github.com/cosmos/cosmos-sdk => github.com/artela-network/artela-cosmos-sdk v0.47.4-artela-beta-6
