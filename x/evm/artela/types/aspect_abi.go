...
var (
	...
	Aspect, _ = abi.NewType("tuple", "struct Overloader.F", []abi.ArgumentMarshaling{
		{Name: "aspectId", Type: "address"},
		{Name: "aspectVersion", Type: "uint64"},
		{Name: "allVersions", Type: "uint64[]"},
		{Name: "aspectCode", Type: "bytes"},
		{Name: "properties", Type: "tuple[]", Components: []abi.ArgumentMarshaling{{Name: "key", Type: "bytes"}, {Name: "value", Type: "bytes"}}},
		{Name: "joinPoints", Type: "string[]"},
...
var methods = map[string]abi.Method{
	"deploy":        abi.NewMethod("deploy", "deploy", abi.Function, "", false, false, []abi.Argument{{"code", Bytes, false}, {"properties", KvPairArr, false}, {"account", Address, false}, {"proof", Bytes, false}, {"joinPoints", Uint64, false}}, nil),
	...
	"getAspect":     abi.NewMethod("getAspect", "getAspect", abi.Function, "", false, false, []abi.Argument{{"aspectId", Address, false}}, []abi.Argument{{"result", Aspect, false}}),
