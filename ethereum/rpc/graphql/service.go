...
import (
	...
	ethgraphql "github.com/ethereum/go-ethereum/graphql"
...
func New(stack types.NetworkingStack, backend ethapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) error {
...
func newHandler(stack types.NetworkingStack, backend ethapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) (*handler, error) {
	...
	stack.RegisterHandler("GraphQL UI", "/graphql/ui", ethgraphql.GraphiQL{})
	stack.RegisterHandler("GraphQL UI", "/graphql/ui/", ethgraphql.GraphiQL{})
