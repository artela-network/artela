...
// NewArtelaCoin is a utility function that returns an "aartela" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewArtelaCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoArtela, amount)
}

// NewArtelaDecCoin is a utility function that returns an "aartela" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewArtelaDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoArtela, amount)
}

// NewArtelaCoinInt64 is a utility function that returns an "aartela" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
